...
?>
  ...
  <div class="content-wrapper">
   ...
   echo "<script>window.alert('pertanyaan selanjutnya')
    window.location='diagnosa6.php'</script>";
    ...
    ?>
            ...
            <!-- Horizontal Form -->
             <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
             <form class="forms-sample" action="diagnosa5.php" method="post" >
                <div class="card-body">
                                             ...
                                             <?php
                                                  include'koneksi.php';
                                                  $no = 1;
                                                  $sql = mysqli_query($koneksi, "SELECT * from gejala WHERE Kd_gejala='G5' ");
