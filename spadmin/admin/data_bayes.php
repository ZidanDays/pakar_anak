  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        $ID = $_GET['ID'];
        $cek = mysqli_query($koneksi, "SELECT * FROM bayes_aturan WHERE ID='$ID'");
        if(mysqli_num_rows($cek) == 0){

          
        }else{
          $delete = mysqli_query($koneksi, "DELETE FROM bayes_aturan WHERE ID='$ID'");
          if($delete){
            
              echo "<script>alert('Data Berhasil di hapus gan!'); window.location = 'data_bayes.php'</script>";
                   ...
                   <table id="zero_config" class="table">
                       ...
                       <td><left>(<?php echo $data['kd_gejala'];?>) -<?php echo $data['gejala'];?></left></td>
                         <td><center><?php echo $data['nilai'];?></center></td>
                                                <td>
                                                  <div class="btn-group">
                                                    <a class="btn btn-sm btn-primary" data-placement="bottom" data-toggle="tooltip" title="Edit Data bayes" href="edit_bayes.php?aksi=edit&ID=<?php echo $data['ID'];?>"><span class="glyphicon glyphicon-edit"></span>Ubah data</a>  
