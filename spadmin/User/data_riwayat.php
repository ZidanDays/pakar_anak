                   ...
                   <table id="zero_config" class="table">
                                        ...
                                        <thead>
                                              <tr>
                                               ...
                                               <th><left>Nama User </center></th>
                        <th><left>Tanggal Diagnosa</left></th>
                        <th><left> Kerusakan yang dialami </center></th>
                           <th><left> Presentase Kerusakan </center></th>
                                              </tr>
                                        </thead>
                                        <tbody>
                                             ...
                                             <?php
                                                  include'koneksi.php';
                                                  $no = 1;
                                                  $sql = mysqli_query($koneksi, "SELECT * from diagnosa WHERE username='$_SESSION[username]' ");
                     ...
                     <td><left><?php echo $data['tgl_diagnosa'];?></left></td>
                      <td><left><?php echo $data['kerusakan'];?></center></td>
                        ...
                        <td><left><?php echo $data['presentase'];?>%</center></td>
                                                <td>
                                                  <div class="btn-group">
                                                    &nbsp;
