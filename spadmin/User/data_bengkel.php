                                            ...
                                            <tr class="table-white">
                                                ...
                                                <td>
                                                  <div class="btn-group">
                                                    ...
                                                    <a class="btn btn-danger" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data ini ?')"  href="index.php?page=hapus_bengkel&id_b=<?php echo $data['id_b']; ?>" class="btn btn-sm btn-danger" title=""><i class="fa fa-trash">Hapus</i></a>
                                                  </div>
                                                </td>
                                            </tr>
            <!-- Edit Modal !-->
