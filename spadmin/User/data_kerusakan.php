      ...
      ?>
                   ...
                   <table id="zero_config" class="table">
                                        <thead>
                                              <tr>
                                                <th><i class=""></i> NO</th>
                                                <th><i class=""></i>Kode Kerusakan</th>
                                            ...
                                            <tr class="table-white">
                                                ...
                                                <td>
                                                  <div class="btn-group">
                                                    ...
                                                    <a class="btn btn-danger" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data ini ?')"  href="index.php?page=hapus_kerusakan&id_k=<?php echo $data['id_k']; ?>" class="btn btn-sm btn-danger" title=""><i class="fa fa-trash">Hapus</i></a>
                                                  </div>
                                                </td>
                                            </tr>
            <!-- Edit Modal !-->
                                          ...
                                          if (isset($_POST['ubah'])){
                                            ...
                                            if($ubah){
                                              ...
                                              alert('Edit Data Berhasil');
                                                document.location.href="data_kerusakan.php?page=kerusakan";
                                               </script>
                                               <?php
                                              }else{
                              ...
                              <div class="modal-dialog">
                                ...
                                <?php
                                  ...
                                  ?>
                                   ...
                                   <div class="form-group">
                                      <label class="control-label" for="kd_kerusakan">Kode Kerusakan</label>
                                      <input type="text" name="kd_kerusakan" class="form-control" id="kd_kerusakan" required="" value="K<?=$kd_ok;?>" readonly="">
                                    </div> 
                                    ...
                                    $solusi = $_POST['solusi'];
                                      ...
                                      if($tambah){
                                        ...
                                        alert('Input Data Berhasil');
                                          document.location.href="data_kerusakan.php";
                                         </script>
                                         <?php
                                        }else{
